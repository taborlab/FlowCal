...
def get_transform_fxn(data_beads,
    ...
    fitting_fxn : function, optional
        ...
        of the beads model, and `fl_channel` and `fl_mef` are the
        fluorescence values of the beads in channel units and MEF units,
        respectively. Note that the standard curve and the fitted beads
