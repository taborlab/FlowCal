...
if __name__ == "__main__":
    ...
    # Note that we are using data both before (``beads_sample``) and after
    # (``beads_sample_gated``) gating. In addition, we are providing
    # ``gate_contour`` from the density gating step, which will be displayed in
    # the density diagram. This will result in a convenient representation of
    # the data both before and after gating.
