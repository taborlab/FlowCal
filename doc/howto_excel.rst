...
1. Make and save an Excel file indicating the FCS files to process. Click :doc:`here </format_excel>` for more information on how to make a properly formatted input Excel file.
...
To see a description of the files generated during the analysis by ``FlowCal``, click :doc:`here </output_excel>`.