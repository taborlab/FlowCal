...
To see ``FlowCal`` in action, head to the :doc:`How to use the Excel UI</excel_ui/how_to>` section. The ``FlowCal`` zip file includes an ``examples`` folder with files that you can use while following the instructions.