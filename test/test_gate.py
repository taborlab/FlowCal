...
class TestHighLowGate(unittest.TestCase):
    ...
    def test_1d_defaults_gated_data(self):
        np.testing.assert_array_equal(
    ...
    def test_1d_inequalities_gated_data(self):
        np.testing.assert_array_equal(
    ...
    def test_2d_channels_gated_data(self):
        np.testing.assert_array_equal(
    ...
    def test_2d_defaults_1_gated_data(self):
        np.testing.assert_array_equal(
    ...
    def test_2d_defaults_2_gated_data(self):
        np.testing.assert_array_equal(
    ...
    def test_2d_inequalities_1_gated_data(self):
        np.testing.assert_array_equal(
    ...
    def test_2d_inequalities_2_gated_data(self):
        np.testing.assert_array_equal(
